...
AUTHENTICATION_BACKENDS = [
    'user.auth_backends.jwt_auth.JSONWebTokenBackend',
    # 'graphql_jwt.backends.JSONWebTokenBackend',  # Default GraphQL JWT
    'user.auth_backends.authentication.AuthenticationBackend',
